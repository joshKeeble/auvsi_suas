...
class InteropParser(object):
    ...
    def post_telemtry(self,lat,lng,alt,heading,speed):
...
def server_handle(data,data_args):
    ...
    [v_lat,v_lng,v_alt,v_heading,v_speed] = data
    interop_parser.post_telemetry(v_lat,v_lng,v_alt,v_heading,v_speed)
    return b'1'
